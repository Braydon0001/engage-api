...
public class SupplierAllowanceSubContractConfiguration : IEntityTypeConfiguration<SupplierAllowanceSubContract>
{
    public void Configure(EntityTypeBuilder<SupplierAllowanceSubContract> builder)
    {
        builder.Property(e => e.SupplierAllowanceContractId).IsRequired();
