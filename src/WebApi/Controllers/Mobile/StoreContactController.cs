...
[Authorize("store")]
public class StoreContactController : BaseMobileController
{
    ...
    public async Task<ActionResult<ListResult<OptionDto>>> ContactOptions([FromRoute] StoreContactEmailMobileOptionQuery query)
    {
        return Ok(await Mediator.Send(query));
    }
