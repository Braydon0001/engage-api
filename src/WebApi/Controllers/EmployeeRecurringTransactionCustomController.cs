...
public partial class EmployeeRecurringTransactionController : BaseController
{
    ...
    public async Task<ActionResult<ListResult<EmployeeRecurringTransactionDto>>> DtoList([FromRoute] EmployeeRecurringTransactionListQuery query, CancellationToken cancellationToken)
    {
