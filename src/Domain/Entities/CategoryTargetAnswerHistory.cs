...
public class CategoryTargetAnswerHistory : BaseAuditableEntity
{
    public int CategoryTargetAnswerHistoryId { get; set; }
    ...
    public CategoryTargetAnswer CategoryTargetAnswer { get; set; }
