...
public class SurveyFormConceptUpdateCommand : IRequest<SurveyFormAnswer>, IMapTo<SurveyFormAnswer>
{
    ...
    {
        profile.CreateMap<SurveyFormConceptUpdateCommand, SurveyFormAnswer>()
               .ForMember(d => d.AnswerUuid, opt => opt.MapFrom(s => ""));
    }

}
public record SurveyFormConceptUpdateHandler(IAppDbContext Context, IMapper Mapper) : IRequestHandler<SurveyFormConceptUpdateCommand, SurveyFormAnswer>
{
    public async Task<SurveyFormAnswer> Handle(SurveyFormConceptUpdateCommand command, CancellationToken cancellationToken)
    {
...
public class SurveyFormConceptUpdateValidator : AbstractValidator<SurveyFormConceptUpdateCommand>
{
    public SurveyFormConceptUpdateValidator()
    {
