...
public class CategoryFileTargetOptionsQuery : IRequest<CategoryFileTargetOptions>
{
    public int Id { get; set; }
}

public class CategoryFileTargetOptionsHandler : IRequestHandler<CategoryFileTargetOptionsQuery, CategoryFileTargetOptions>
{
    private readonly IAppDbContext _context;
    private readonly IMapper _mapper;

    public CategoryFileTargetOptionsHandler(IAppDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<CategoryFileTargetOptions> Handle(CategoryFileTargetOptionsQuery query, CancellationToken cancellationToken)
    {
        ...
        return new CategoryFileTargetOptions(employeeJobTitles, employees, enageRegions, storeFormats, stores, categoryGroups, engageSubGroups);
    }
}
