...
public record ProjectTaskVmQuery(int Id) : IRequest<ProjectTaskVm>;

public record ProjectTaskVmHandler(IAppDbContext Context, IMapper Mapper) : IRequestHandler<ProjectTaskVmQuery, ProjectTaskVm>
{
    public async Task<ProjectTaskVm> Handle(ProjectTaskVmQuery query, CancellationToken cancellationToken)
    {
        ...
        var mappedEntity = entity == null ? null : Mapper.Map<ProjectTaskVm>(entity);
