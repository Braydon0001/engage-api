...
public class CommunicationHistoryProjectDto : IMapFrom<CommunicationHistoryProject>
{
    ...
    {
        profile.CreateMap<CommunicationHistoryProject, CommunicationHistoryProjectDto>()
