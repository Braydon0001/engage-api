...
public class EmployeeStoreCalendarGetSurveyFormWithAnswersQuery : IRequest<EmployeeStoreCalendarSurveyFormsDto>
{
    public int Id { get; set; }
}
public record EmployeeStoreCalendarGetSurveyFormWithAnswersHandler(IAppDbContext Context, IMapper Mapper, IMediator Mediator) : IRequestHandler<EmployeeStoreCalendarGetSurveyFormWithAnswersQuery, EmployeeStoreCalendarSurveyFormsDto>
{
    public async Task<EmployeeStoreCalendarSurveyFormsDto> Handle(EmployeeStoreCalendarGetSurveyFormWithAnswersQuery query, CancellationToken cancellationToken)
    {
