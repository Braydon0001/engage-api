...
public class EmployeeStoreCalendarInsertNextCommand : IMapTo<EmployeeStoreCalendar>, IRequest<EmployeeStoreCalendar>
{
    ...
    {
        profile.CreateMap<EmployeeStoreCalendarInsertNextCommand, EmployeeStoreCalendar>();
    }
}

public class EmployeeStoreCalendarInsertNextHandler : InsertHandler, IRequestHandler<EmployeeStoreCalendarInsertNextCommand, EmployeeStoreCalendar>
{
    ...
    public EmployeeStoreCalendarInsertNextHandler(IAppDbContext context, IMapper mapper, IOptions<FeatureSwitchOptions> featureSwitchOptions, IOptions<ContactReportSettings> contactReportSettings, IMediator mediator, IUserService user) : base(context, mapper)
    {
    ...
    public async Task<EmployeeStoreCalendar> Handle(EmployeeStoreCalendarInsertNextCommand command, CancellationToken cancellationToken)
    {
        var entity = _mapper.Map<EmployeeStoreCalendarInsertNextCommand, EmployeeStoreCalendar>(command);
        List<SurveyForm> surveyForms = await _context.SurveyForms.Where(e => command.SurveyFormIds.Contains(e.SurveyFormId)).ToListAsync(cancellationToken);
...
public class EmployeeStoreCalendarInsertNextValidator : AbstractValidator<EmployeeStoreCalendarInsertNextCommand>
{
    public EmployeeStoreCalendarInsertNextValidator()
    {
