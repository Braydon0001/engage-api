...
public class SurveyFormStoreConceptTargetedMobileQuery() : IRequest<HistoryStoreSurveys>
{
...
public class SurveyFormStoreConceptTargetedMobileHandler(IAppDbContext context, IMapper mapper) : IRequestHandler<SurveyFormStoreConceptTargetedMobileQuery, HistoryStoreSurveys>
{
    private readonly IAppDbContext _context = context;
    private readonly IMapper _mapper = mapper;
    public async Task<HistoryStoreSurveys> Handle(SurveyFormStoreConceptTargetedMobileQuery query, CancellationToken cancellationToken)
    {
        ...
        var targetedSurveyForms = await _context.SurveyFormTargets
                                   .Where(e => e.SurveyForm.SurveyFormTypeId == (int)SurveyFormTypeId.Concept
                                        //&& (e.SurveyForm.EndDate == null)
        ...
        var completedSurveys = await _context.SurveyFormSubmissions.Where(e => e.IsComplete
                                                                         ...
                                                                         && e.SurveyForm.SurveyFormType.SurveyFormTypeId == (int)SurveyFormTypeId.Concept)
                                                                   .Select(e => e.SurveyFormId)
                                                                   .ToListAsync(cancellationToken);
        ...
        var entites = await queryable.Where(e => e.Disabled == false && e.Deleted == false
                                        && (e.EndDate == null)
                                                 ...
                                                 && e.SurveyFormType.SurveyFormTypeId == (int)SurveyFormTypeId.Concept
        ...
        var historySurveys = await queryable.Where(e => surveyFormIds.Contains(e.SurveyFormId)).OrderByDescending(e => e.Created).ToListAsync(cancellationToken);
