...
public class ProjectMobileVm : IMapFrom<Project>, IMapFrom<ProjectStore>
{
    ...
    public List<ProjectProjectTagMobileDto> ClaimTagIds { get; set; }
    public List<ProjectProjectTagMobileDto> EmployeeJobTitleTagIds { get; set; }
    ...
    {
        profile.CreateMap<Project, ProjectMobileVm>()
        ...
        profile.CreateMap<ProjectStore, ProjectMobileVm>()
               .ForMember(d => d.Id, opt => opt.MapFrom(s => s.ProjectId))
               .ForMember(d => d.ProjectTypeId, opt => opt.MapFrom(s => s.ProjectType))
               .ForMember(d => d.ProjectStatusId, opt => opt.MapFrom(s => s.ProjectStatus))
               .ForMember(d => d.ProjectPriorityId, opt => opt.MapFrom(s => s.ProjectPriority))
