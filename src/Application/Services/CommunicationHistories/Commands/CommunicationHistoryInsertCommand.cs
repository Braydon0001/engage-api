...
public class CommunicationHistoryInsertCommand : IMapTo<CommunicationHistory>, IRequest<CommunicationHistory>
{
    ...
    {
        profile.CreateMap<CommunicationHistoryInsertCommand, CommunicationHistory>();
    }
}

public record CommunicationHistoryInsertHandler(IAppDbContext Context, IMapper Mapper, IHandlebarsService HandlebarsService) : IRequestHandler<CommunicationHistoryInsertCommand, CommunicationHistory>
{
    public async Task<CommunicationHistory> Handle(CommunicationHistoryInsertCommand command, CancellationToken cancellationToken)
    {
        var entity = Mapper.Map<CommunicationHistoryInsertCommand, CommunicationHistory>(command);
        ...
        {
            Context.CommunicationHistories.Add(entity);
...
public class CommunicationHistoryInsertValidator : AbstractValidator<CommunicationHistoryInsertCommand>
{
    public CommunicationHistoryInsertValidator()
    {
