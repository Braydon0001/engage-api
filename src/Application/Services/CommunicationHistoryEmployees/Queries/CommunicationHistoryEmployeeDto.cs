...
public class CommunicationHistoryEmployeeDto : IMapFrom<CommunicationHistoryEmployee>
{
    ...
    {
        profile.CreateMap<CommunicationHistoryEmployee, CommunicationHistoryEmployeeDto>()
