...
public class EmployeeTransactionsAmountDeductionDto : IMapFrom<EmployeeTransaction>
{
    ...
    {
        profile.CreateMap<EmployeeTransaction, EmployeeTransactionsAmountDeductionDto>()
