...
public class EmployeeTransactionsAmountDeductionRecurringDto : IMapFrom<EmployeeTransaction>
{
    ...
    {
        profile.CreateMap<EmployeeTransaction, EmployeeTransactionsAmountDeductionRecurringDto>()
