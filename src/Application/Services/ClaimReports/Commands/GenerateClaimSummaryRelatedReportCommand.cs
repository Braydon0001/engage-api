...
public class GenerateClaimSummaryRelatedReportCommand : GetQuery, IRequest<ReportListVM<ReportSubTotal>>
{
    //Required
...
public class GenerateClaimSummaryRelatedReportCommandHandler : BaseQueryHandler, IRequestHandler<GenerateClaimSummaryRelatedReportCommand, ReportListVM<ReportSubTotal>>
{
    public GenerateClaimSummaryRelatedReportCommandHandler(IAppDbContext context, IMapper mapper) : base(context, mapper)
    {
    }

    public async Task<ReportListVM<ReportSubTotal>> Handle(GenerateClaimSummaryRelatedReportCommand command, CancellationToken cancellationToken)
    {
        ...
        string reportName = "Summary Report" + " - " + DateTime.Now.ToString() + " " + string.Join(" - ", claimClassifications.Select(c => c.Name));
        ...
        return new ReportListVM<ReportSubTotal>
        {
            ...
            ClassificationName = string.Join(" - ", claimClassifications.Select(c => c.Name)),
