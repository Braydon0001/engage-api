...
public record CategoryFileEmployeeTargetedQuery(int EmployeeId, int StoreId, DateTime Date) : IRequest<CategoryFileAdvancedTargetingVm>
{
}

public class CategoryFileEmployeeTargetedHandler : IRequestHandler<CategoryFileEmployeeTargetedQuery, CategoryFileAdvancedTargetingVm>
{
    private readonly IAppDbContext _context;
    private readonly IMapper _mapper;

    public CategoryFileEmployeeTargetedHandler(IAppDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<CategoryFileAdvancedTargetingVm> Handle(CategoryFileEmployeeTargetedQuery query, CancellationToken cancellationToken)
    {
