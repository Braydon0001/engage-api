...
public class SurveyFormNextInsertCommand : IMapTo<SurveyForm>, IRequest<SurveyForm>
{
    ...
    {
        profile.CreateMap<SurveyFormNextInsertCommand, SurveyForm>();
    }
}

public record SurveyFormNextInsertHandler(IAppDbContext Context, IMapper Mapper, IMediator Mediator, IFileService File) : IRequestHandler<SurveyFormNextInsertCommand, SurveyForm>
{
    public async Task<SurveyForm> Handle(SurveyFormNextInsertCommand command, CancellationToken cancellationToken)
    {
        var entity = Mapper.Map<SurveyFormNextInsertCommand, SurveyForm>(command);
...
public class SurveyFormNextInsertValidator : AbstractValidator<SurveyFormNextInsertCommand>
{
    public SurveyFormNextInsertValidator()
    {
