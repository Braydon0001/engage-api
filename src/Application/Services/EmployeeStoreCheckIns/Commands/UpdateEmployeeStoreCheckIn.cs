...
public class UpdateEmployeeStoreCheckInCommand : EmployeeStoreCheckInCommand, IRequest<OperationStatus>, IMapTo<EmployeeStoreCheckIn>
{
    ...
    {
        profile.CreateMap<UpdateEmployeeStoreCheckInCommand, EmployeeStoreCheckIn>();
    }
}

public class UpdateEmployeeStoreCheckInCommandHandler : BaseUpdateCommandHandler, IRequestHandler<UpdateEmployeeStoreCheckInCommand, OperationStatus>
{
    public UpdateEmployeeStoreCheckInCommandHandler(IAppDbContext context, IMapper mapper, IMediator mediator) : base(context, mapper, mediator)
    {
    }

    public async Task<OperationStatus> Handle(UpdateEmployeeStoreCheckInCommand command, CancellationToken cancellationToken)
    {
        try
        {
